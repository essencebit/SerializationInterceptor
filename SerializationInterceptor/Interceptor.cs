...
namespace SerializationInterceptor
{
	...
	public static class Interceptor
	{
		...
		/// <exception cref="EnumerableNotSupportedException">Thrown when <paramref name="obj"/> is or contains an enumerable not supported by interceptor</exception>
		/// <exception cref="TypeNotAttributeException">Thrown when any of the evaluated attribute interceptors of <typeparamref name="T"/> have as input param a type that is not an attribute</exception>
		...
		/// <param name="context">Serialization context</param>
		/// <exception cref="EnumerableNotSupportedException">Thrown when <paramref name="obj"/> is or contains an enumerable not supported by interceptor</exception>
		/// <exception cref="TypeNotAttributeException">Thrown when any of the evaluated attribute interceptors of <paramref name="objType"/> have as input param a type that is not an attribute</exception>
		...
		/// <param name="abstractConcreteMap">A mapping between the abstract types and their concrete implementations</param>
		/// <param name="context">Deserialization context</param>
		/// <returns>Deserialized object</returns>
		/// <exception cref="EnumerableNotSupportedException">Thrown when <typeparamref name="T"/> is or contains an enumerable not supported by interceptor</exception>
		/// <exception cref="TypeNotAttributeException">Thrown when any of the evaluated attribute interceptors of <typeparamref name="T"/> have as input param a type that is not an attribute</exception>
		/// <exception cref="AbstractTypeNotMappedException">Thrown when <typeparamref name="T"/> is or contains an abstract type(enumerables not counted) which is not included in <paramref name="abstractConcreteMap"/></exception>
		...
		/// <param name="context">Deserialization context</param>
		/// <returns>Deserialized object</returns>
		/// <exception cref="EnumerableNotSupportedException">Thrown when <paramref name="objType"/> is or contains an enumerable not supported by interceptor</exception>
		/// <exception cref="TypeNotAttributeException">Thrown when any of the evaluated attribute interceptors of <paramref name="objType"/> have as input param a type that is not an attribute</exception>
		/// <exception cref="AbstractTypeNotMappedException">Thrown when <paramref name="objType"/> is or contains an abstract type(enumerables not counted) which is not included in <paramref name="abstractConcreteMap"/></exception>
